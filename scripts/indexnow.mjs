...
// dist, not public: the sitemap is generated by the prerender step now, so
// this needs a build to have run. Reading the old public/ path silently
// submitted a stale URL list right up until the file stopped existing.
